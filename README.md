...
Light Kali is licensed under the **Light Kali Restricted Use License (LK-RUL) v1.0**.

You may use Light Kali and develop independent Packages, Plugins, Extensions, Themes, and Integrations for it.

Modification, forking, redistribution of modified versions, or unauthorized derivative works of the Light Kali Core are not permitted.
